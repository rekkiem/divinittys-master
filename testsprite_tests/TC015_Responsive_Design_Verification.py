...
async def run_test():
    ...
    try:
        ...
        await expect(frame.locator('text=info@Divinittys.com').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=© 2026 Divinittys. Todos los derechos reservados.').first).to_be_visible(timeout=30000)
